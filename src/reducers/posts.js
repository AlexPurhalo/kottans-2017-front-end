...
export const INITIAL_STATE = { postsList: null, allowToAddPost: false };

// Action types import
import { FETCH_POSTS_SUCCESS, POST_POST_SUCCESS } from '../constants/posts';
...
export default (state = INITIAL_STATE, action) => {
	switch(action.type) {
		case AUTO_SIGN_IN:
			return { ...state, allowToAddPost: true };
		case POST_USER_SUCCESS:
			return { ...state, allowToAddPost: true };
		case POST_SESSION_SUCCESS:
			return { ...state, allowToAddPost: true };
		case DESTROY_SESSION_SUCCESS:
			return { ...state, allowToAddPost: false };
